       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>PRODUCTOS <small class="tittles-pages-logo">DANIELITA STORE</small></h1>
            </div>
            <?php
            ...
            ?>
              <div class="row">
                <?php
                  ...
                  $consultar_productos=mysqli_query($mysqli,"SELECT SQL_CALC_FOUND_ROWS * FROM producto WHERE CodigoCat='$categoria' AND Stock > 0 LIMIT $inicio, $regpagina");
