    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
              <h1>PEDIDOS <small class="tittles-pages-logo">DANIELITA STORE</small></h1>
            </div>
            <br><br><br>
            <div class="row">
      ...
      <div class="modal-dialog" role="document">
        <form class="modal-content FormCatElec" action="process/confirmcompra.php" method="POST" role="form" data-form="save">
          ...
          <div class="modal-body">
            ...
            ?>
            <p>Por favor haga el depósito en la siguiente cuenta bancaria e ingrese el número de deposito que le proporciona el comprobante.</p><br>
            <p>
              ...
              <strong>Tipo de cuenta:</strong> <?php echo $datBank['TipoCuenta']; ?><br><br>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="NumDepo" placeholder="Ingrese el número de depósito" maxlength="50" required="">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="Cedclien" placeholder="Cédula del cliente" maxlength="15" required="">
                </div>
                <div class="form-group">
                ...
                <?php else: ?>
                    <div class="form-group">
                        <label>Numero de Deposito/comprobante</label>
                        <input class="form-control" type="text" name="NumDepo" placeholder="Ingrese Numero de comprobante" maxlength="50" required="">
                    </div>
                    <div class="form-group">
                      <span>Tipo De Envio</span>
                      <select class="form-control" name="tipo-envio" data-toggle="tooltip" data-placement="top" title="Elige El Tipo De Envio">
