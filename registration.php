    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1> REGISTRARSE EN   <small class="tittles-pages-logo">  TIENDA VIRTUAL: VIVERES DANIELITA</small></h1>
            </div>
            <p class="lead text-center">
              Si es un nuevo usuario y desea utlizar nuestro servicio, es necesario llenar los datos con todos los campos que a continuación le pedimos para crear su cuenta.
            </p>
            <div class="row">
                ...
                <div class="col-sm-7">
                    <div id="container-form">
                       <p class="text-center lead">Registro de Cliente Nuevo</p>
                       <br><br>
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-12">
                                <div class="form-group label-floating">
                                  <label class="control-label"><i class="fa fa-address-card-o" aria-hidden="true"></i>&nbsp; Ingrese su número de Cédula</label>
                                  <input class="form-control" type="text" required name="clien-nit" pattern="[0-9]{1,15}" title="Ingrese su número de Cédula. Solamente números" maxlength="15" >
                                </div>
                              </div>
                              ...
                              <div class="col-xs-12">
                                <div class="form-group label-floating">
                                  <label class="control-label"><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp; Ingrese un nombre de usuario</label>
